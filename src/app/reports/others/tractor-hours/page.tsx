        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <Link href="/reports" className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white mr-4">
        ...
        <div className="max-w-7xl mx-auto space-y-4">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 dark:border-gray-700/20 p-4">
            <div className="space-y-4">
              ...
              {/* Custom Date Range - Compact single line */}
          ...
          {/* Summary Statistics - Only Total Hours and Avg Hours */}
          {summary && (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                    ...
                    <div className="mt-2 sm:mt-0 flex flex-wrap gap-3 text-sm">
                      <button className="px-3 py-1.5 bg-blue-500 text-white rounded-md font-semibold text-sm">
                        {tractor.opening_hours.toFixed(1)}
                      </button>
                      <button className="px-3 py-1.5 bg-green-500 text-white rounded-md font-semibold text-sm">
                        {tractor.closing_hours.toFixed(1)}
                      </button>
                      <button className="px-3 py-1.5 bg-purple-500 text-white rounded-md font-semibold text-sm">
                        {tractor.total_difference.toFixed(1)}h
                      </button>
