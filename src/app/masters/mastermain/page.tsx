...
import { ArrowLeft, UserPlus, Truck, Users } from 'lucide-react'

export default function Masters() {
  const items = [
    { title: 'Create Customer', icon: UserPlus, color: 'bg-blue-500', href: '/masters/createcustomer' },
    { title: 'Create Employee', icon: Users, color: 'bg-green-500', href: '/masters/createemployee' },
    { title: 'Create Tractor', icon: Truck, color: 'bg-yellow-500', href: '/masters/createtractor' },
  ]
