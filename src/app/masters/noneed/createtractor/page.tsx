    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit} className={`max-w-lg mx-auto ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-md rounded-lg p-8`}>
          ...
          <div className="mb-6">
            <label htmlFor="next_insurance_date" className={`block text-sm font-medium mb-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
              Next Insurance Date (Optional)
            </label>
            <input
              type="date"
              id="next_insurance_date"
