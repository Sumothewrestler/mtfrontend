...
export default function EditCustomerPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const [customerResponse, tagsResponse] = await Promise.all([
          fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}customers-detail/${id}/`),
  ...
  const handleCreateTag = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setCustomer({ ...customer, tags: newTag.id })
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/masters/customers/view")
      }, 1500)
    } catch (err) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="relative h-48">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-orange-200"></div>
          </div>
          ...
          <div className="px-6 pb-8 sm:px-10 sm:pb-10 pt-6">
            ...
            <div className={`max-w-2xl mx-auto ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-md rounded-xl p-8`}>
              {isLoading && !error ? (
            ...
            <form onSubmit={handleCreateTag}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={handleTagFormChange}
                  className={`w-full h-10 border rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 ${
