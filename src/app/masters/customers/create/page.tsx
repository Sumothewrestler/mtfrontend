      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="relative h-32">
            ...
            <div className="absolute top-0 right-0 w-48 h-48 rounded-full bg-emerald-400 opacity-20 translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute top-0 right-0 w-36 h-36 rounded-full bg-green-300 opacity-30 translate-x-1/3 -translate-y-1/3"></div>
            <div className="absolute top-0 right-0 w-24 h-24 rounded-full bg-lime-200 opacity-40 translate-x-1/4 -translate-y-1/4"></div>
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <div>
                  <div className="flex items-center mb-1">
                    ...
                    <h1 className="text-2xl font-bold text-white drop-shadow-md">Create Customer</h1>
                  </div>
                </div>
